                        ...
                        <div className="flex items-start justify-end">
                          <div className="flex items-center ml-3 h-7">
                            <button
                              onClick={onClose}
                              type="button"
                              className="text-gray-400 bg-white rounded-md hover:text-gray-500 focus:outline-none focus:ring-sky-500 focus:ring-offset-2"
                            >
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <div className="flex gap-10 my-8">
                            ...
                            >
                              ...
                              <div className="text-sm font-light text-neutral-600"> 删除 </div>
                            </div>
                          </div>
                          ...
                          <div className="w-full pt-5 pb-5 sm:px-0 sm:pt-0">
                            <dl className="px-4 space-y-8 sm:space-y-6 sm:px-6">
                              ...
                              {data.isGroup && (
                                <div>
                                  <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">邮箱</dt>
                              ...
                              {!data.isGroup && (
                                <>
                                  <hr />
                                  <div>
                                    <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">加入日期</dt>
                                    <dd className="mt-1 text-sm text-gray-900 sm:col-span-2">
